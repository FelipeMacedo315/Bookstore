  ...
  <div class="sign">
    <div class="ilustrator">
      ...
      <p class="txt-subtitle">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio, esse voluptas modi eaque
        nostrum dolor laboriosam aliquam excepturi reiciendis praesentium, voluptatem provident
        culpa voluptate nemo illum, facere delectus ut assumenda!
      </p>
    </div>
